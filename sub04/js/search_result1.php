  ...
  <h4 style="margin-top:30px;"><a href="/BBS/index.php">홈으로</a></h4>
    <table class="list-table">
      <thead>
        ...
        <?php
          $sql2 = query("select * from board where $catagory like '%$search_con%' order by regist_day desc");
          ...
          $title=$board["title"]; 
            ...
            $sql3 = query("select * from reply where con_num='".$board['regist_day']."'");
            $rep_count = mysqli_num_rows($sql3);
        ?>
      <tbody>
        <tr>
          <td width="70"><?php echo $board['regist_day']; ?></td>
          <td width="500">
            <?php 
              $lockimg = "<img src='/BBS/img/lock.png' alt='lock' title='lock' with='20' height='20' />";
              if($board['lock_post']=="1")
              { ?><a href='/BBS/ck_read.php?regist_day=<?php echo $board["regist_day"];?>'><?php echo $title, $lockimg;
              }else{?>
